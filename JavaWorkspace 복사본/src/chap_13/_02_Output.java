...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%d%n",1); //정수 출력 %n 은 줄바꿈
        System.out.printf("%d %d %d%n", 1, 2, 3);
        System.out.printf("%d%n", 1234);
        System.out.printf("%6d%n",1234); //__1234(6자리의 공간을 확보하고 1234를 넣는다.)
        System.out.printf("%06d%n", 1234); //001234(6자리 공간을 확보 후 1234 출력하는데 빈 공간은 0으로 채움)
        System.out.printf("%6d%n", -1234); //_-1234
        System.out.printf("%+6d%n", 1234); //_+1234 (항상 기호를 표시)
        ...
        System.out.printf("%6.2f%n",Math.PI); //__3.14 (6자리 공간 확봐고 소수점 둘째자리)
        ...
        System.out.printf("%6.2s%n","Java"); //____Ja (6자리 공간 확보하고 우측 정렬 2글자 출력)
        System.out.printf("%-6.2s%n","Java"); //Ja____(6자리 공간 확보하고 좌측 정렬 2글자 출력)
        ...
        System.out.println("이름      영어   수학    평균"); //공백이 각각 6, 3, 4 칸을 구분
        ...
        //영어 숫자 한글각각 서로 필요로 하는 자릿수 를 먹는 것이 다르다
    }
}
