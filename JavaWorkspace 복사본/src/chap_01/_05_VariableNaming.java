...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        String purposeOfVisit = "관광"; //입국국적
        String _flight_No = "KE657"; // 밑줄 시작
        String fliht_No_2 = "KE657"; // 밑줄과 숫자 포함
        //String - flightNo = "KE657"; 하이푼으로 시작 불가

        int accompany =2 ; //동반 가족
        int lenghtOfStay = 5; //체류 기간

        String item = "시계";
        String item2 = "가방";
//        String 3 item = "전자제품"; 숫자 시작 불가
        ...
        //절대 변하지 않는 상수는 대문자로 (상수는 선언하면 업데이트를 할 수 없이 유지된다)
